...
// Generated from chat-hygiene.test.ts by scripts/generate-variant-tests.mjs
...
describe('chat hygiene', () => {
  ...
  describe('transcript-noise guard', () => {
    it('engine.suppressTranscriptNoise drops obvious transcript junk (variant)', () => {
  ...
  describe('fallback never uses a date as the anchor', () => {
    it('"we were discussing **Friday, May 15, 2026**" must not appear (variant)', async () => {
  ...
  describe('fallback varies between consecutive turns', () => {
    it('two unknown questions in a row produce different fallbacks (variant)', async () => {
  ...
  describe('common-knowledge coverage — no honest-gap fallback', () => {
    ...
    const cases: Array<[string, RegExp]> = [
      ...
      // Round 12
      ['who was Franz Liszt?', /\b(?:Hungarian|virtuoso|pianist|symphonic poem|Weimar|Lisztomania|Doborján|Raiding|Esterházy|Czerny|Salieri|Transcendental|Années|Sonata|Hungarian Rhapsod|Mephisto|Liebesträume|campanella|Totentanz|Faust|Dante|Wagner|Cosima|Bayreuth|abbé|1811|1886)\b/i],
      ['who was Felix Mendelssohn?', /\b(?:German|Romantic|Hamburg|Bartholdy|Moses Mendelssohn|Fanny|Octet|Midsummer Night's Dream|Hebrides|Fingal|Wedding March|Italian|Scottish|Reformation|Violin Concerto|Elijah|St\. Paul|Songs Without Words|Lieder ohne Worte|Leipzig|Gewandhaus|Bach|St\. Matthew|Singakademie|1809|1847|Zelter)\b/i],
      ['who was Hector Berlioz?', /\b(?:French|Romantic|Symphonie fantastique|idée fixe|Harriet Smithson|Roméo et Juliette|Harold en Italie|Paganini|Requiem|Grande Messe|Te Deum|Damnation de Faust|enfance du Christ|Benvenuto Cellini|Béatrice|Troyens|Les nuits|Treatise|Orchestration|Conservatoire|Prix de Rome|Côte-Saint-André|Mémoires|1803|1869)\b/i],
      ['who was Lise Meitner?', /\b(?:Austrian|Swedish|physicist|Vienna|Berlin|Otto Hahn|Otto Frisch|protactinium|nuclear fission|fission|Anschluss|Sweden|Stockholm|Manhattan|Nobel|Hahn|meitnerium|element 109|Mt|Max Planck Medal|Fermi Award|Cambridge|1878|1968)\b/i],
      ['who was Paul Dirac?', /\b(?:English|British|theoretical physicist|quantum mechanics|Dirac equation|positron|antiparticle|Bristol|St John's|Cambridge|Lucasian|Schrödinger|Nobel|1933|bra-ket|delta function|magnetic monopole|Principles of Quantum Mechanics|Florida State|Tallahassee|Westminster Abbey|Fowler|1902|1984|strangest)\b/i],
      ['who was Wolfgang Pauli?', /\b(?:Austrian|theoretical physicist|exclusion principle|Pauli exclusion|spin|neutrino|Vienna|Mach|Sommerfeld|Munich|ETH|Zürich|Nobel|1945|Pauli matrices|relativity|Bohr|Princeton|Cowan|Reines|fine-structure|137|Jung|not even wrong|1900|1958)\b/i],
      ['who was Christiaan Huygens?', /\b(?:Dutch|mathematician|astronomer|physicist|The Hague|Leiden|Titan|Saturn|ring|pendulum clock|Horologium Oscillatorium|wave theory|light|Huygens' principle|Traité de la lumière|Systema Saturnium|balance spring|Hooke|Académie|probability|Constantijn|1629|1695|Galileo|cycloidal)\b/i],
      ['who was Ernst Mach?', /\b(?:Austrian|physicist|philosopher|Brno|Vienna|Graz|Prague|Mach number|shock wave|supersonic|schlieren|Mach bands|Mach cone|Mechanik|Science of Mechanics|Newton|absolute space|Mach's principle|Einstein|Vienna Circle|Analyse der Empfindungen|atom|Boltzmann|1838|1916)\b/i],
      ['who is Anubis?', /\b(?:Egyptian|jackal|mummification|embalming|dead|cemetery|necropolis|Anpu|Inpu|Osiris|Nephthys|Isis|Set|Weighing of the Heart|Book of the Dead|Maat|feather|Ammit|Thoth|Cynopolis|Lycopolis|Imy-ut|black|First Dynasty)\b/i],
      ['who is Ra the Egyptian sun god?', /\b(?:Egyptian|sun god|Heliopolis|Iunu|falcon|solar disk|uraeus|Mandjet|Mesektet|Apep|Apophis|Duat|Khepri|Atum|Ra-Horakhty|Amun-Ra|Akhenaten|Aten|Hathor|Sekhmet|Shu|Tefnut|Maat|Fifth Dynasty|Amduat|Book of Gates|Litany of Re|barque)\b/i],
      ['who is Isis the Egyptian goddess?', /\b(?:Egyptian|goddess|Aset|Iset|throne|Osiris|Horus|Geb|Nut|Set|Nephthys|Plutarch|De Iside|magic|motherhood|kingship|Philae|Justinian|Pompeii|Iseum|mystery|Apuleius|Golden Ass|tyet|Hathor|wings)\b/i],
      ['who is Horus?', /\b(?:Egyptian|falcon|sky god|kingship|pharaoh|Eye of Horus|wedjat|Isis|Osiris|Set|Heru|Hor|Harpocrates|Horus the Child|Horus the Elder|Horus of Behdet|Edfu|Hor-akhty|Horakhty|Ra-Horakhty|Contendings|Thoth|serekh|pschent|double crown)\b/i],
      ['who is Tyr the Norse god?', /\b(?:Norse|Æsir|Aesir|war|oath|law|combat|Fenrir|Gleipnir|Ragnarök|Garmr|Hymir|Odin|hand|wolf-joint|úlfliðr|Þing|rune|Tīwaz|Tuesday|Tīw|Mars|Gylfaginning|Snorri|Prose Edda|sky-father)\b/i],
      ['who is Heimdall?', /\b(?:Norse|Æsir|Aesir|Bifröst|Ásgard|Asgard|Gjallarhorn|Ragnarök|Loki|Brísingamen|Brisingamen|Freyja|nine mothers|Gulltoppr|Golden Mane|Mímir|Yggdrasil|Rígsþula|Ríg|thrall|karl|jarl|Singasteinn|seal|Vindlér|Gullintanni|hvíti áss|hvíti|hearing|watchman|Snorri|Prose Edda)\b/i],
    ];
